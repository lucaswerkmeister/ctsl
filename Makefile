...
install: $(TSC_MODULE_JSFILE) $(TSC_MODULE_MODELFILE) $(TSC_MODULE_JSFILE).sha1 $(TSC_MODULE_MODELFILE).sha1 TypeScript/lib/lib.es6.d.ts
	mkdir -p ~/.ceylon/repo/$(TSC_MODULE_NAME)/$(TSC_MODULE_VERSION)
	cp -r $^ ~/.ceylon/repo/$(TSC_MODULE_NAME)/$(TSC_MODULE_VERSION)
	mv ~/.ceylon/repo/$(TSC_MODULE_NAME)/$(TSC_MODULE_VERSION)/lib.es6.d.ts ~/.ceylon/repo/$(TSC_MODULE_NAME)/$(TSC_MODULE_VERSION)/lib.d.ts
